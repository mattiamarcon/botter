...
export default function Navbar(){
    ...
    return (
        <Headroom className="text-white text-2xl font-semibold w-full bg-blue-800 ">
            <nav className="h-24 flex flex-row justify-between z-20 cursor-pointer relative ">
            ...
            <ul id="navbarElements" className="flex items-center hidden absolute  w-full bg-blue-800 flex-col md:hidden">
                <NavbarElements />
            </ul>
        </Headroom>
    );
